...
export const products: Product[] = [
  ...
  { name: "Pneu 10×2.5 renforcé", price: 120, stock: "En stock", visual: "tire", image: "/products/pneu-tubeless-8065-6.png", category: "Pneus", compatibleModels: ["Ninebot G30", "Kugoo M4"], badge: "Meilleure vente" },
  ...
  { name: "Plaquettes de frein", price: 35, stock: "En stock", visual: "brakes", image: "/products/levier-frein-xiaomi.png", category: "Freins", compatibleModels: ["Xiaomi M365", "Ninebot ES"] },
  ...
  { name: "Chargeur 42V", price: 150, stock: "En stock", visual: "charger", image: "/products/chargeur-42v-2a.png", category: "Chargeurs", compatibleModels: ["Xiaomi M365", "Pro 2"], badge: "Nouveau" },
  ...
  { name: "Écran LCD 36V", price: 190, stock: "En stock", visual: "display", image: "/products/dashboard-m365-pro.png", category: "Écrans", compatibleModels: ["Xiaomi M365", "Pro 2"] },
  { name: "Écran LCD 48V", price: 250, stock: "En stock", visual: "display", image: "/products/dashboard-pro2-essential.png", category: "Écrans", compatibleModels: ["Kugoo M4", "Kaabo Mantis"] },
  { name: "Kit éclairage LED", price: 95, stock: "En stock", visual: "display", image: "/products/feu-arriere-pro2.png", category: "Accessoires", compatibleModels: ["Universel"] },
