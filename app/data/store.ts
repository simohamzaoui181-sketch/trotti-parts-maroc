...
export const products: Product[] = [
  ...
  { name: "Pneu 10×2.5 renforcé", price: 120, stock: "En stock", visual: "tire", image: "/products/pneu-10x25-renforce.jpg", category: "Pneus", compatibleModels: ["Ninebot G30", "Kugoo M4"], badge: "Meilleure vente" },
  ...
  { name: "Plaquettes de frein", price: 35, stock: "En stock", visual: "brakes", image: "/products/plaquettes-frein.jpg", category: "Freins", compatibleModels: ["Xiaomi M365", "Ninebot ES"] },
  ...
  { name: "Chargeur 42V", price: 150, stock: "En stock", visual: "charger", image: "/products/chargeur-42v.jpg", category: "Chargeurs", compatibleModels: ["Xiaomi M365", "Pro 2"], badge: "Nouveau" },
  ...
  { name: "Écran LCD 36V", price: 190, stock: "En stock", visual: "display", image: "/products/ecran-lcd-36v.jpg", category: "Écrans", compatibleModels: ["Xiaomi M365", "Pro 2"] },
  { name: "Écran LCD 48V", price: 250, stock: "En stock", visual: "display", image: "/products/ecran-lcd-48v.jpg", category: "Écrans", compatibleModels: ["Kugoo M4", "Kaabo Mantis"] },
  { name: "Kit éclairage LED", price: 95, stock: "En stock", visual: "display", image: "/products/kit-eclairage-led.jpg", category: "Accessoires", compatibleModels: ["Universel"] },
